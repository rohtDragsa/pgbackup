...
def test_parser_with_driver(parser):
    """
    The parser will exit if it receivs a driver without a destination
    """
    with pytest.raises(SystemExit):
...
def test_parser_with_unknown_driver(parser):
    """
    The paerser will exit if the driver name is unknown
    """
...
def test_parser_with_known_driver(parser):
    """
    The parser will not ecit if the driver name is known
    """
